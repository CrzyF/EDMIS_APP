...
const HomePage = ({navigation}) => {
  return (
    ...
    >
     ...
     <TouchableOpacity style={[styles.vectorIcon3, styles.iconLayout]} onPress={() => navigation.navigate("LiveStream")}>
     ...
     <Image
      ...
      />
      <Text style={[styles.text, styles.textPosition]}>From</Text>
      <Text style={[styles.text1, styles.textPosition]}>SOFTMASTERS</Text>
    </ImageBackground>
  );
};
